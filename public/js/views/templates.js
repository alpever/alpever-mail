        ...
        <div class="card" style="display: flex; flex-direction: column; justify-content: space-between;">
          ...
          <div style="display: flex; align-items: center; justify-content: space-between; padding-top: 14px; border-top: 1px solid var(--border-subtle);">
            ...
            <div style="display: flex; gap: 8px;">
              ...
              <button class="btn btn-secondary btn-sm" style="color: #ef4444; border-color: #fee2e2; background: #fff5f5; padding: 6px 10px;" onclick="deleteTemplate(${t.id})" title="Delete template">
